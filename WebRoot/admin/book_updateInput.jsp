...
<head>
<base href="<%=basePath%>">
<title>网上图书超市后台管理-图书管理-修改图书信息</title>
        ...
        <tr>
          <td width="26%" height="395" valign="top"><table width="100%"  border="0" cellspacing="-2" cellpadding="-2">
            <tr>
              ...
              <td width="45%" align="left" class="word_grey">修改图书信息</td>
            </tr>
            <tr>
          ...
          <td width="73%" valign="top"><table width="100%" height="56"  border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td align="center">
			  <form action="admin/book_update?book.id=<s:property value="book.id"/>" method="post" name="form1">
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    <td width="14%" height="27">&nbsp;书　　号：</td>
                    <td height="27">&nbsp;
                      <input name="book.ISBN" type="text" class="Sytle_text" id="bookISBN" value="<s:property value="book.ISBN"/>">
</td>
                    <td height="27">&nbsp;书　　名：</td>
                    <td height="27">&nbsp;
                          <input name="book.name" type="text" class="Style_upload" id="bookName" value="<s:property value="book.name"/>">
                    </td>
                  </tr>
                  <tr>
                    <td height="27">&nbsp;作　　者：</td>
                    <td width="25%" height="27">&nbsp;
                          <input name="book.author" type="text" class="Style_upload" id="bookAuthor" value="<s:property value="book.author"/>">
                    </td>
                    <td width="15%" height="27"> &nbsp;类别名称：</td>
                    <td width="46%" height="27">&nbsp;
                          <input name="book.bookType" type="text" class="Sytle_text" id="bookType" value="<s:property value="book.bookType"/>">
                    </td>
                  </tr>
                  <tr>
                    <td height="27">&nbsp;出&nbsp;版&nbsp;社：</td>
                    <td height="27">&nbsp;
                          <input name="book.publisher" type="text" class="Style_upload" id="bookPublisher" value="<s:property value="book.publisher"/>">
                    </td>
                    <td height="27">&nbsp;发行日期：</td>
                    <td height="27">&nbsp;
                          <input name="book.date" type="text" class="Sytle_text" id="bookDate" value="<s:property value="book.date"/>">
                   </td>
                  </tr>
                  <tr>
                    <td height="41">&nbsp;封面文件：</td>
                    <td height="41">&nbsp;
                          <input name="book.img" type="text" class="Style_upload" id="bookImg" value="<s:property value="book.img"/>">
                    </td>
                    <td height="41">&nbsp;价　　格：</td>
                    <td height="41">&nbsp;
                          <input name="book.price" type="text" class="Sytle_text" id="bookPrice" value="<s:property value="book.price"/>"/>
      (元)</td>
                  </tr>
                  <tr>
                    <td height="45">&nbsp;是否推荐：</td>
                    <td>&nbsp; <input name="book.commend" type="radio" class="noborder" value="1" <s:if test="book.commend==1">checked</s:if> >
是
  <input name="book.commend" type="radio" class="noborder" value="0" <s:if test="book.commend==0">checked</s:if>>
否</td>
                    <td>&nbsp;是否新书：</td>
                    <td><input name="book.newFlag" type="radio" class="noborder" value="1" <s:if test="book.newFlag==1">checked</s:if>>
是
  <input name="book.newFlag" type="radio" class="noborder" value="0" <s:if test="book.newFlag==0">checked</s:if>>
否</td>
                  </tr>
                  <tr>
                    <td height="103">&nbsp;图书简介：</td>
                    <td colspan="3"><span class="style5">&nbsp; </span>
                        <textarea name="book.introduction" cols="60" rows="5" class="textarea" id="bookIntroduce"><s:property value="book.introduction"/></textarea></td>
                  </tr>
                  <tr>
