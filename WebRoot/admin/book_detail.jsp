...
<head>
<base href="<%=basePath%>">
<title>网上图书超市后台管理-图书管理-图书详细信息</title>
													...
													<form action="book_modify_deal.jsp" method="post"
														...
														<table width="100%" border="1" align="center"
															...
															<tr>
																...
																<td height="27">&nbsp;<s:property value="book.ISBN"/> </td>
																<td height="27">&nbsp;书 名：</td>
																<td height="27">&nbsp;<s:property value="book.name"/></td>
															</tr>
															<tr>
																<td height="27">&nbsp;作 者：</td>
																<td width="25%" height="27">&nbsp;<s:property value="book.author"/>
																</td>
																<td width="15%" height="27">&nbsp;类别名称：</td>
																<td width="46%" height="27">&nbsp;<s:property value="book.bookType"/>
																</td>
															</tr>
															<tr>
																<td height="27">&nbsp;出&nbsp;版&nbsp;社：</td>
																<td height="27">&nbsp;<s:property value="book.publisher"/>
																</td>
																<td height="27">&nbsp;发行日期：</td>
																<td height="27">&nbsp;<s:property value="book.date"/></td>
															</tr>
															<tr>
																<td height="41">&nbsp;封面文件：</td>
																<td height="41">&nbsp;<s:property value="book.img"/></td>
																<td height="41">&nbsp;价 格：</td>
																<td height="41">&nbsp;<s:property value="book.price"/>
																	(元)</td>
															</tr>
															<tr>
